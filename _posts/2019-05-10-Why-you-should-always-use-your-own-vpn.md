...
{% include img.html src="/graphs/internet-connection-without-vpn.png" alt="Traffic pattern when not using VPN" aspect_ratio=28.74 %}
...
{% include img.html src="/graphs/internet-connection-with-vpn-provider.png" alt="Traffic pattern when using VPN provider" aspect_ratio=30.38  %}
...
{% include img.html src="/graphs/internet-connection-with-personal-vpn.png" alt="Traffic pattern use of personal VPN" aspect_ratio=33.37  %}
